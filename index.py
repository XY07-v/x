...
def generar_reporte():
    try:
        ...
        # 1. Cargar datos (MES como texto según tu instrucción)
        ...
        # 3. Lógica de iconos: -1 es ✔️ y vacío es ❌
        df = df.fillna('❌')
        ...
        <body>
            <div class="card">
                <h2>📊 Reporte Operativo Manpower</h2>
                <div class="filtros">
